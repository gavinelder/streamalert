...
[path/to/file.json]
        ...
        set_parser.add_argument(
            "-t", "--table", help="Name of the LookupTable", required=True
        )

        set_parser.add_argument(
            "-k", "--key", help="Key to modify on the LookupTable", required=True
        )
...
class LookupTablesListAddSubCommand(CLICommand):
    ...
    def setup_subparser(cls, subparser):
        ...
        set_parser.add_argument(
            "-v", "--value", help="Value to add to the key", required=True
        )
        ...
        set_parser.add_argument(
            "-s", "--sort", help="Sort the final list", action="store_true"
        )
...
class LookupTablesDescribeTablesSubCommand(CLICommand):
    ...
    def handler(cls, options, config):
        ...
        lookup_tables = LookupTablesMagic.get_all_tables(
...
class LookupTablesGetKeySubCommand(CLICommand):
    ...
    def setup_subparser(cls, subparser):
        ...
        get_parser.add_argument(
            "-k", "--key", help="Key to fetch on the LookupTable", required=True
        )
...
class LookupTablesSetSubCommand(CLICommand):
    ...
    def setup_subparser(cls, subparser):
        ...
        set_parser.add_argument(
            "-k", "--key", help="Key to set on the LookupTable", required=True
        )

        set_parser.add_argument(
            "-v", "--value", help="Value to save into LookupTable", required=True
        )
