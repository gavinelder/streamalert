...
class AppIntegration(metaclass=ABCMeta):
    ...
    def __init__(self, event, context):
        ...
        self._batcher = Batcher(
            self._config.function_name, self._config.destination_function
        )
    ...
    def _initialize(self):
        ...
        LOGGER.info(
            "App executing as a successive invocation: %s",
    ...
    def _finalize(self):
        ...
        LOGGER.info(
            "[%s] App complete; gathered %d logs in %d polls.",
            self,
            self._gathered_log_count,
            self._poll_count,
        )
    ...
    def _gather(self):
        ...
        LOGGER.debug(
            "Updating config last timestamp from %s to %s",
            self._config.last_timestamp,
    ...
    def gather(self):
        ...
        try:
            ...
            while (
                (self._gather() * self._POLL_BUFFER_MULTIPLIER) + self._sleep_seconds()
