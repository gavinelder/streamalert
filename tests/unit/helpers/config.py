...
def basic_streamalert_config():
    ...
    return {
        "global": {
            ...
            "general": {"terraform_files": ["/test/terraform/file.tf"]},
            "infrastructure": {
                "monitoring": {},
                "s3_access_logging": {
        ...
        "threat_intel": {
            ...
            "enabled": False,
            "excluded_iocs": {},
            "normalized_ioc_types": {"ip": ["sourceAddress", "destinationAddress"]},
        },
        "normalized_types": {
            "test_cloudtrail": {"sourceAddress": ["sourceIPAddress"]},
            "test_cloudwatch": {"destinationAddress": ["destination"]},
        },
        "logs": {
            "json_log": {"schema": {"name": "string"}, "parser": "json"},
            "json:log.with.dots": {"schema": {"name": "string"}, "parser": "json"},
            "csv_log": {
                "schema": {"data": "string", "uid": "integer"},
                "parser": "csv",
            },
        },
        "lambda": {
            "alert_merger_config": {"memory": 128, "timeout": 10},
            "alert_processor_config": {"memory": 128, "timeout": 10},
        ...
        "clusters": {
            "prod": {
                ...
                "data_sources": {"kinesis": {"stream_1": ["json_log", "csv_log"]}},
                "modules": {
                    "cloudwatch_monitoring": {"enabled": True},
                    "kinesis": {"streams": {"retention": 24, "shards": 1}},
...
def athena_cli_basic_config():
    return {
        ...
        "logs": {"unit:my_test": {"schema": {"name": "string"}, "parser": "json"}},
        "lambda": {"athena_partitioner_config": {}},
    }
