...
from pytest import assert_equal, assert_raises, nottest
...
class TestTestRunner(fake_filesystem_unittest.TestCase):
    ...
    def test_process_test_file_bad_service(self, log_mock):
        ...
        assert_raises(
            ConfigError, self.runner._process_test_file, self._DEFAULT_EVENT_PATH
        )
    ...
    )  # patch stdout to suppress integration test result
