...
def test_generate_scheduled_queries():
    ...
    expected_sq_config = {
        'module': {
            'scheduled_queries': {
                'source':
                './modules/tf_scheduled_queries',
                'destination_kinesis_stream':
                'unit-test_stream',
                'sfn_timeout_secs':
                3600,
                'sfn_wait_secs':
                ...
                'unit-test-streamalert-athena-results',
                'athena_s3_buckets': [
                ...
                'lambda_handler':
                'streamalert.scheduled_queries.main.handler',
                'query_packs': [{
                    'name': 'hourly',
                ...
                1,
                'lambda_error_period_secs':
                3600,
                'lambda_error_evaluation_periods':
                2,
