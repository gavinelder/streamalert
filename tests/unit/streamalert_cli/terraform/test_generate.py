...
class TestTerraformGenerate:
    ...
    def test_generate_s3_bucket_lifecycle(self):
        ...
        assert type(bucket["lifecycle_rule"]) == dict
        assert type(bucket["versioning"]) == dict
    ...
    def test_generate_main_with_firehose(self):
        ...
        self.config["global"]["infrastructure"]["firehose"] = {
            ...
            "buffer_size": 10,
            "buffer_interval": 650,
            "enabled_logs": {"cloudwatch": {"enable_alarm": False}},
        }
        tf_main = generate.generate_main(config=self.config, init=False)
        ...
        assert (
            generated_modules["kinesis_firehose_cloudwatch_test_match_types"][
                "s3_bucket_name"
            ]
            == "my-data"
        )
    ...
    def test_generate_main_alerts_firehose(self):
        ...
        assert tf_main["module"]["globals"]["alerts_firehose_buffer_interval"] == 600
    ...
    def test_generate_cloudtrail_cloudwatch_logs_and_s3(self):
        ...
        expected = {
            ...
            "cloudtrail_s3_events_unit-test_advanced_unit-test-advanced-streamalert-cloudtrail": {
                ...
                "filters": [{"filter_prefix": "AWSLogs/456789012345/CloudTrail/"}],
            },
        }
    ...
    def test_generate_cloudwatch_destinations(self):
        ...
        cloudwatch_destinations.generate_cloudwatch_destinations(
            "advanced", self.cluster_dict, self.config
        )
    ...
    def test_generate_cwe_cross_acct_map_regions(self):
        ...
        settings = {
            "accounts": {"123456789012": ["us-east-1"], "234567890123": ["us-east-1"]},
            "organizations": {"o-aabbccddee": ["us-west-1"]},
        }
        ...
        expected = {
            ...
            "us-west-1": {"organizations": ["o-aabbccddee"]},
        }
    ...
    def test_generate_optional_lambda_not_in_config(self, log_mock):
        ...
        log_mock.assert_called_with(
            "Optional configuration missing in lambda.json, skipping: %s",
            fake_opt_conf_name,
        )
