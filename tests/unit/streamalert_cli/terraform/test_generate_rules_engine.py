    ...
    def setup(self):
        ...
        self.config = {
            "global": {
                ...
                "infrastructure": {
                    "monitoring": {"sns_topic_name": "test_topic"},
                    "rule_staging": {"enabled": False},
                },
            },
            "threat_intel": {"dynamodb_table_name": "test_table", "enabled": False},
            "lambda": {
                "rules_engine_config": {
                    "log_level": "info",
                    ...
                    "timeout": 60,
                    "vpc_config": {"security_group_ids": [], "subnet_ids": []},
                }
            },
        }
        ...
        expected_result = {
            "module": {
                "rules_engine_iam": {
                    ...
                    "dynamodb_table_name": self.config["threat_intel"][
                        "dynamodb_table_name"
                    ],
