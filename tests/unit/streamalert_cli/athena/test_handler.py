...
class TestAthenaCli:
    ...
    def test_construct_create_table_statement():
        ...
        schema = {
            "value01": "string",
            "value02": "integer",
            "value03": {"value04": "boolean", "value05": "float"},
        }

        expected_result = (
            "CREATE EXTERNAL TABLE table-name (value01 string, value02 integer, "
        ...
        result = handler._construct_create_table_statement(
            schema, "table-name", "bucket-name"
        )
    ...
    @staticmethod
    @patch(
        "streamalert.shared.athena.AthenaClient.check_table_exists",
