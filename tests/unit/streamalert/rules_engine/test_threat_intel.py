...
class TestThreatIntel:
    ...
    def _default_config(self):
        return {
            "threat_intel": {
                ...
                "enabled": True,
                "excluded_iocs": {
                    "domain": {"not.evil.com": {"comment": "not an evil domain"}}
                },
            ...
            "clusters": {"prod": {"enable_threat_intel": True}},
        }
    ...
    def test_insert_ioc_info_existing(self):
        ...
        expected_result = {
            "key": "value",
            "streamalert:ioc": {ioc_type: {existing_value, new_value}},
        }
    ...
    def testg_client_error(self, log_mock):
        ...
        with patch.object(self._threat_intel, "_query") as query_mock:
            ...
            log_mock.assert_called_with(
                "An error occurred while querying dynamodb table"
            )
    ...
    def test_query_unprocessed_keys(self):
        ...
        self._threat_intel._dynamodb.batch_get_item.side_effect = [
            {
                "UnprocessedKeys": {  # UnprocessedKeys will cause this to retry once
                    "table_name": {"Keys": [{"ioc_value": {"S": "2.2.2.2"}}]}
                },
                "Responses": {
                    "table_name": [
                        {
        ...
        expected_result = [
            {"ioc_value": "1.1.1.1", "sub_type": "mal_ip"},
            {"ioc_value": "01d0a70299bb8985caad5107dbcf138e", "sub_type": "mal_md5"},
            {"ioc_value": "2.2.2.2", "sub_type": "mal_ip"},
        ]
    ...
    def test_remove_processed_keys(self):
        ...
        unprocesed_keys = [
            {"ioc_value": {"S": "2.2.2.2"}, "sub_type": {"S": "mal_ip"}},
            {
                "ioc_value": {"S": "09bb8985ca0a702907dbcfad511d138e"},
                "sub_type": {"S": "mal_md5"},
            },
        ]
    ...
    def test_deserialize(self):
        ...
        expected_result = [
            {"ioc_value": "09bb8985ca0a702907dbcfad511d138e", "sub_type": "mal_md5"}
        ]
    ...
    def test_is_excluded_ioc(self):
        ...
        assert self._threat_intel._is_excluded_ioc("domain", "not.evil.com") == True
    ...
    def test_is_excluded_ioc_ip(self):
        ...
        assert self._threat_intel._is_excluded_ioc("ip", "1.2.3.15") == True
    ...
    def test_setup_excluded_iocs(self):
        ...
        excluded_iocs = {
            "md5": {"feca1deadbeefcafebeadbeefcafebee": {"comment": "not malicious"}}
        }
    ...
    def test_load_from_config(self):
        ...
        assert isinstance(ti_client, ThreatIntel) == True
