...
from pytest import assert_equals, assert_true, assert_false
...
class TestAthenaClient:
    ...
    def setup(self):
        ...
        self._athena = AthenaClient(
            logger=MagicMock(name="Logger"), client=self._athena_client
        )
    ...
    def test_get_query_execution(self):
        ...
        assert (
            query_execution.query_execution_id == "e5b4a7e1-270b-42f8-8062-cfc5daa1e97f"
        )
...
class TestAthenaQueryExecution:
    SAMPLE_RUNNING_RESPONSE = {
        "QueryExecution": {
            ...
            "QueryExecutionContext": {"Database": "streamalert"},
            "Status": {
                "State": "RUNNING",
                "SubmissionDateTime": datetime(
                    2019, 6, 5, 21, 50, 15, 525000, tzinfo=tzlocal()
                ),
            },
            "Statistics": {
        ...
        "QueryExecution": {
            ...
            "Status": {
                ...
                "CompletionDateTime": datetime(
                    2019, 6, 5, 21, 50, 21, 770000, tzinfo=tzlocal()
                ),
            },
            "Statistics": {
    ...
    def test_completion_datetime(self):
        ...
        assert self._succeeded_execution.completion_datetime == datetime(
            2019, 6, 5, 21, 50, 21, 770000, tzinfo=tzlocal()
        )
    ...
    SAMPLE_RESULT = {
        ...
        "ResultSet": {
            "Rows": [
                ...
                {"Data": [{"VarCharValue": "2019-06-04"}, {}, {"VarCharValue": "1"}]},
                {
                    "Data": [
