...
from pytest import assert_equals, assert_false, assert_true
...
class TestQueryPack:
    ...
    def test_query_execution_start(self):
        ...
        self._execution.athena_client.run_async_query.assert_called_with(
            "MOCK QUERY STRING"
        )
...
class TestQueryPacksManager:
    ...
    def test_start_queries(self):
        ...
        self._execution_context.query_pack_repository.get_packs.return_value = [
            config1,
            config2,
        ]
...
class TestQueryParameterGenerator:
    ...
    def test_generate_advanced_function(self):
        ...
        assert (
            self._generator.generate_advanced("thing", thing) == "2019-01-01-01-01-01"
        )
