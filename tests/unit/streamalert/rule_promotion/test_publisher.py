...
class TestStatsPublisher:
    ...
    def test_formatted_sns_topic_arn_default(self):
        ...
        test_config = {
            ...
            "lambda": {"rule_promotion_config": {}},  # no digest_sns_topic here
        }
...
\u25E6 test_rule_0
    ...
    def test_query_alerts_none(self, publish_mock):
        ...
        with patch.object(
            self.publisher, "_athena_client", new_callable=PropertyMock
        ) as mock:
    ...
    def test_query_alerts_bad_reponse(self):
        ...
        with patch.object(
            ...
            assert_raises(
                athena.AthenaQueryExecutionError, self.publisher._query_alerts, stat
            )
	...
	- Alert Info:					n/a""",
        ...
        boto_mock.resource.return_value.Topic.return_value.publish.assert_called_with(
            **args
        )
