...
class TestAthenaPartitioner:
    ...
    @patch(
        "streamalert.athena_partitioner.main.load_config",
    ...
    def test_get_partitions_from_keys_parquet(self):
        ...
        expected_result = {
            "alerts": {
                "(dt = '2017-08-26-14')": (
                    "'s3://unit-test-streamalerts/" "parquet/alerts/dt=2017-08-26-14'"
                ),
                "(dt = '2017-08-27-14')": (
                    "'s3://unit-test-streamalerts/" "parquet/alerts/dt=2017-08-27-14'"
                ),
                "(dt = '2017-08-26-15')": (
                    "'s3://unit-test-streamalerts/" "parquet/alerts/dt=2017-08-26-15'"
                ),
            },
            "log_type_1": {
                "(dt = '2017-08-26-14')": (
    ...
    def test_get_partitions_from_keys_error(self, log_mock):
        ...
        log_mock.assert_called_with(
            "The key %s does not match any regex, skipping", bad_key.decode("utf-8")
        )
        assert result == dict()
    ...
    def _s3_record(count):
        return {
            "Records": [
                {
                    "s3": {
                        "bucket": {"name": "unit-test-streamalerts"},
                        "object": {
                            "key": (
                                "parquet/alerts/dt=2017-08-{:02d}-"
            ...
            "Records": [
                {
                    ...
                    "attributes": {"SentTimestamp": "1534284301036"},
                }
            ]
        }
    ...
    def test_get_partitions_from_keys_json(self):
        ...
        expected_result = {
            "alerts": {
                ...
                "(dt = '2017-08-26-15')": (
                    "'s3://unit-test-streamalerts/" "alerts/2017/08/26/15'"
                ),
            },
            "log_type_1": {
                "(dt = '2017-08-26-14')": (
                    "'s3://unit-test-streamalert-data/" "log_type_1/2017/08/26/14'"
                )
            },
            "log_type_2": {
                "(dt = '2017-08-26-14')": (
                    "'s3://unit-test-streamalert-data/" "log_type_2/2017/08/26/14'"
                ),
                "(dt = '2017-08-26-15')": (
                    "'s3://unit-test-streamalert-data/" "log_type_2/2017/08/26/15'"
                ),
                "(dt = '2017-08-26-16')": (
                    "'s3://unit-test-streamalert-data/" "log_type_2/2017/08/26/16'"
                ),
            },
            "log_type_3": {
                "(dt = '2017-08-26-14')": (
                    "'s3://unit-test-streamalert-data/" "log_type_3/2017/08/26/14'"
                ),
            },
        }
