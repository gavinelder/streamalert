...
class TestThreatStream:
    ...
    @patch(
        "streamalert.threat_intel_downloader.main.load_config",
    ...
    def _get_http_response(next_url=None):
        return {
            ...
            "objects": [
                ...
                TestThreatStream._get_fake_intel(
                    "malicious_domain2.com", "test_source"
                ),
            ],
            "meta": {"next": next_url, "offset": 100},
        }
    ...
    def test_write_to_dynamodb_table(self, boto_mock):
        ...
        batch_writer = (
            boto_mock.return_value.Table.return_value.batch_writer.return_value
        )
