...
class TestJSONParser:
    ...
    def _json_regex_key_options(cls):
        return {
            "schema": {"nested_key_01": "string", "nested_key_02": "string"},
            "configuration": {
                "envelope_keys": {"time": "string", "date": "string", "host": "string"},
    ...
    def test_invalid_json_path(self):
        ...
        options = {
            ...
            "configuration": {"json_path": "Records[*]"},
        }
    ...
    def test_envelope_keys_optional_values(self):
        ...
        record_data = json.dumps(
            {
                "message": json.dumps({"nested_key_01": "foo", "nested_key_02": "bar"}),
                "date": "2017/10/01",
                "time": "14:00:00",
            }
        )
    ...
    def test_multi_nested_json(self):
        ...
        options = {
            "schema": {"name": "string", "result": "string"},
            "configuration": {"json_path": "profiles.controls[*]"},
        }
    ...
    def test_json_regex_key(self):
        ...
        expected_result = [
            {"nested_key_01": "nested_info", "nested_key_02": "more_nested_info"}
        ]
    ...
    def test_embedded_json(self):
        ...
        options = {
            ...
            "configuration": {
                "embedded_json": True,
                "envelope_keys": {"env_key_01": "string", "env_key_02": "string"},
                ...
                "test_list": [
                    {
                        "id": "foo",
                        "message": json.dumps(
                            {"nested_key_01": "bar", "nested_key_02": "baz"}
                        ),
                    }
                ],
            }
        ...
        record_data = json.dumps(
            {
                "env_key_01": "data",
                "env_key_02": "time",
                "test_list": [{"id": "foo", "message": invalid_data}],
            }
        )
    ...
    def test_nested_records_with_missing_keys(self):
        ...
        options = {
            "schema": {"computer_name": "string", "group": "integer"},
            "configuration": {"json_path": "Records[*]"},
        }
        ...
        record_data = json.dumps(
            {
                "Records": [
                    {"computer_name": "foo", "group": 3},
                    {"computer_name": "foo-bar", "group": 3},
                    {
                        # Missing group key
        ...
        record_data = json.dumps(
            {
                ...
                "username": "test_user",
                "docs": [
                    {"md5": "58B8702C20DE211D1FCB248D2FDD71D1", "opt_key": "exists"},
                    {
            ...
            "Records": [
                {
                    ...
                    "requestParameters": {"streamName": "streamalert"},
                ...
                },
                {
                    ...
                    "requestParameters": {"streamName": "streamalert_prod"},
                    "eventType": "AwsApiCall",
                    "responseElements": None,
                    "awsRegion": "us-east-1",
                    "eventName": "DescribeStream",
    ...
    def test_extract_via_json_path_bad_json(self, log_mock):
        ...
        options = {
            "schema": {"key": "string"},
            "configuration": {"embedded_json": True, "json_path": "key[].value"},
        }
        ...
        log_mock.assert_any_call(
            "Embedded json is invalid: %s", "Expecting value: line 1 column 1 (char 0)"
        )
    ...
    def test_extract_via_json_path_not_dict(self, log_mock):
        ...
        log_mock.assert_any_call(
            "Embedded json is invalid: %s", "record data is not a dictionary"
        )
    ...
    def test_extract_via_json_regex_key_no_key(self):
        ...
        options = {
            "schema": {"key": "string"},
            "configuration": {"json_regex_key": "key_01"},
        }
        record_data = {"key": "value"}
