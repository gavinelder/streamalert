...
class TestParserBaseConfiguration:
    ...
    def setup(self):
        ...
        options = {
            ...
            "configuration": {
                ...
                "log_patterns": {"host": ["foo*"]},
                "json_path": "logEvents[].message",
                "envelope_keys": {"env_key_01": "string"},
    ...
    def test_schema_property(self):
        ...
        expected_result = {"timestamp": "string", "host": "string"}
    ...
    def test_envelope_schema_property(self):
        ...
        expected_result = {"env_key_01": "string"}
...
class TestParserBaseClassMethods:
    ...
    def test_default_optional_values_list(self):
        ...
        assert ParserBase.default_optional_values(list()) == []

    def test_default_optional_values_dict(self):
        """ParserBase - Default Optional Type, Dictionary"""
        assert ParserBase.default_optional_values(dict()) == {}
    ...
    def test_apply_envelope(self):
        ...
        expected_record = {
            "key": "value",
            "streamalert:envelope_keys": {"env_key_01": "value"},
        }
    ...
    def test_matches_log_patterns_str(self, log_mock):
        ...
        assert ParserBase._matches_log_patterns(record, patterns) == True
    ...
    def test_matches_log_patterns_none(self):
        ...
        record = {"key": "value"}
        assert ParserBase._matches_log_patterns(record, {}) == True
    ...
    def test_key_check_no_schema(self):
        ...
        assert ParserBase._key_check(None, {}) == True
    ...
    def test_key_check_bad_envelope_subset(self, log_mock):
        ...
        log_mock.assert_called_with(
            "Missing keys in record envelope: %s", {"env_key_01"}
        )
    ...
    def test_key_check_nested(self):
        ...
        schema = {"key": "string", "nested": {"key_01": "string"}}
        record = {"key": "value", "nested": {"key_01": "value"}}
        assert ParserBase._key_check(record, schema) == True
    ...
    def test_convert_type_str(self):
        ...
        schema = {"key": "string"}
        record = {"key": 100}
        assert ParserBase._convert_type(record, schema) == True
    ...
    def test_convert_type_optionals(self, log_mock):
        ...
        assert ParserBase._convert_type(record, schema, optionals) == True
...
class TestParserBaseMethods:
    ...
    def test_validate_schema_all(self):
        ...
        assert parser._validate_schema() == True
    ...
    def test_validate_schema_top_level(self):
        ...
        options = {
            ...
            "configuration": {"optional_top_level_keys": ["host"]},
        }
    ...
    def test_validate_schema_invalid(self):
        ...
        options = {
            ...
            "configuration": {"optional_top_level_keys": ["date"]},
        }
    ...
    def test_parse(self):
        ...
        options = {
            "schema": {"key": "string"},
            "configuration": {"optional_top_level_keys": ["non_key"]},
        }
