...
class TestPayloadRecord:
    ...
    def test_non_zero_false(self):
        ...
        assert bool(self._payload_record) == False
    ...
    def test_non_zero_true(self):
        ...
        assert bool(self._payload_record) == True
    ...
    def test_repr_invalid_records(self):
        ...
        self._payload_record._parser = self._mock_parser(
            records=[self._record], invalid_records=[self._record]
        )
        expected_result = (
    ...
    def test_invalid_records_property(self):
        ...
        self._payload_record._parser = self._mock_parser(
            records=[
                self._record
            ],  # the parser must have records to be considered valid at all
