...
from pytest import assert_count_equal, assert_equal, assert_false, assert_true, raises
...
class TestAliyunApp:
    ...
    def setup(self):
        ...
        self._context = get_mock_lambda_context(
            self._test_app_name, milliseconds=100000
        )
    ...
    def test_required_auth_info(self):
        ...
        ) == collections.Counter({"access_key_id", "access_key_secret", "region_id"})
    ...
    def test_gather_logs_no_more_entries(self, client_mock):
        ...
        client_mock.return_value = (
            '{"RequestId":"B1DE97F8-5450-4593-AB38-FB61B799E91D",'
    ...
    def test_gather_logs_last_timestamp(self, client_mock, sleep_mock, batcher_mock, _):
        ...
        client_mock.side_effect = [
            json.dumps(r, separators=(",", ":")) for r in mock_resps
        ]
