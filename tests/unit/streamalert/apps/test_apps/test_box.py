...
from pytest import assert_equal, assert_false, assert_count_equal, assert_true
import requests
...
class TestBoxApp:
    ...
    def test_gather_logs(self):
        ...
        with patch.object(self._app, "_client") as client_mock:
            client_mock.make_request.return_value.json.return_value = (
                self._get_sample_payload(10)
            )
    ...
    def test_gather_logs_requests_timeout_retry_success(self, log_mock):
        ...
        with patch.object(self._app, "_client") as client_mock:
            ...
            assert bool(self._app._gather_logs()) == True
    ...
    def test_gather_logs_no_results(self, log_mock):
        ...
        with patch.object(self._app, "_client") as client_mock:
            ...
            assert not self._app._gather_logs()
            log_mock.assert_called_with(
                "[%s] No results received in request", self._app
            )
