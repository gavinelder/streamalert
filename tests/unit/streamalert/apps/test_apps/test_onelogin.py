...
class TestOneLoginApp:
    ...
    def test_required_auth_info(self):
        ...
        assert collections.Counter(list(self._app.required_auth_info().keys())) == collections.Counter({'region', 'client_secret', 'client_id'})
    ...
    def test_get_onelogin_events_rate_limited(self, requests_mock):
        ...
        err_limit_response = Mock(status_code=400,
                                  json=Mock(
                                      return_value={
        ...
        ok_limit_response = Mock(status_code=200,
    ...
    def test_gather_logs_no_pagination(self, requests_mock):
        ...
        requests_mock.return_value = Mock(status_code=200, json=Mock(side_effect=[logs]))
    ...
    def test_set_onelogin_rate_limit_sleep(self, requests_mock):
        ...
        requests_mock.return_value = Mock(
            status_code=200,
            json=Mock(return_value={'data': {
                'X-RateLimit-Reset': new_rate_limit_sleep
            }}))
