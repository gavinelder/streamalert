...
from pytest import assert_equal, assert_false, assert_count_equal, assert_is_none
...
class TestIntercomApp:
    ...
    def test_required_auth_info(self):
        ...
        assert collections.Counter(
            self._app._required_auth_info().keys()
        ...
        return {
            ...
            "activity_logs": [
                ...
                },
                {
                    ...
                    "metadata": {
                        "message": {"id": "5678", "title": "All things cool"},
                        "before": "draft",
                        "after": "live",
                    },
                    "created_at": "1537218403",
                    "activity_type": "message_state_change",
                    "activity_description": "Also Cool Admin changed your All things cool message from draft to live.",
                },
            ],
        }
    ...
    def test_headers(self):
        return {
            "Authorization": "Bearer %s" % self._app._config.auth["token"],
    ...
    def test_gather_intercom_logs_bad_response(self, requests_mock):
        ...
        requests_mock.return_value = Mock(
            status_code=404, content="something went wrong"
        )
    ...
    def test_gather_intercom_logs_no_pagination(self, requests_mock, time_mock):
        ...
        params = {"created_at_before": 100, "created_at_after": 0}
    ...
    @patch("calendar.timegm")
    @patch("requests.get")
    def test_gather_intercom_logs_response_with_next_page(
        self, requests_mock, time_mock
    ):
    ...
    @patch("calendar.timegm")
    @patch("requests.get")
    def test_gather_intercom_logs_setting_last_timestamp(
        self, requests_mock, time_mock
    ):
    ...
    def test_gather_intercom_logs_by_last_timestamp(self, requests_mock, time_mock):
        ...
        params = {"created_at_before": 100, "created_at_after": 1537218402}
