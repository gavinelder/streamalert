...
from pytest import assert_equal, assert_false, assert_true, assert_dict_equal, raises
...
class TestAppConfig:
    ...
    def test_get_parameters_invalid_json(self):
        ...
        with patch.dict(os.environ, {"AWS_DEFAULT_REGION": "us-east-1"}):
            ...
            boto3.client("ssm").put_parameter(
                Name=key, Value="foobar", Type="SecureString", Overwrite=True
            )
    ...
    def test_set_item(self, log_mock):
        ...
        log_mock.assert_called_with(
            "Current state cannot be saved with value '%s'", bad_state
        )
