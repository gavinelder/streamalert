...
def put_mock_params(app_type):
    ...
    for key, value in params.items():
        ssm_client.put_parameter(Name=key,
...
def _get_auth_info(app_type):
                ...
                'boxAppSettings': {
                    ...
                    'appAuth': {
                        ...
                        'privateKey': ('-----BEGIN ENCRYPTED PRIVATE KEY-----\n'
                                       ...
                                       'PRIVATE KEY-----\n'),
                        'passphrase':
                        'e8a88b08eff2797234d6313686f7bad7'
                    }
                },
                'enterpriseID': '12345678'
            }
        }
    if app_type == 'log_audit':
        return {'AuthHeader': 'Basic AYHjlkf92JGHDjgf'}
    if app_type == 'aliyun':
        return {
    ...
    if app_type == 'github':
        return {
            'gh-organization': 'example',
            'gh-logs': 'all',
            'gh-token': 'ghp_i9foin98fn983nfionoinwfoinwoif89yf',
            'gh-app-identifier': '12345678'
        }
    ...
    if app_type == 'slack':
        return {'auth_token': 'xoxp-aaaaaaa-111111111-eeeeeeeeee-fffffff'}

    # Fill this out with future supported apps/services

    # Return basic test info
    return {'host': 'foobar', 'secret': 'barfoo'}
...
class MockLambdaClient:
    ...
    def invoke(cls, **kwargs):
        ...
        if not isinstance(kwargs['Payload'],
...
def get_event(app_type):
    ...
    return {
        ...
        'destination_function_name': 'unit_test_prefix_unit_test_cluster_streamalert_classifier'
    }
