...
from pytest import assert_equal, assert_false, assert_raises, assert_true
...
class TestNormalizer:
    ...
    def _normalized_type_ip(cls):
        return NormalizedType(
            ...
            "ip_address",
            [
                {"path": ["sourceIPAddress"], "function": "source ip address"},
                {"path": ["detail", "source"], "function": "source ip address"},
            ],
        )
    ...
    def _normalized_type_region(cls):
        return NormalizedType(
            ...
            "region",
            [
                {"path": ["region"], "function": "AWS region"},
                {"path": ["detail", "awsRegion"], "function": "AWS region"},
            ],
        )
    ...
    def test_match_types(self):
        ...
        expected_results = {
            ...
            "ipv4": [
                {"values": ["1.1.1.3"], "function": "source ip address"},
                {"values": ["1.1.1.2"], "function": "source ip address"},
            ],
            "region": [
                {"values": ["region_name"], "function": "AWS region"},
                {"values": ["region_name"], "function": "AWS region"},
            ],
        }
    ...
    def test_match_types_multiple(self):
        ...
        expected_results = {
            ...
            "user_identity": [
                {"values": ["Alice"], "function": "User name"},
                {"values": ["signin.amazonaws.com"], "function": "Service name"},
            ],
        }
    ...
    def test_normalize_corner_case(self):
        ...
        Normalizer._types_config = {
            log_type: {
                "normalized_key": NormalizedType(
                    log_type, "normalized_key", ["original_key", "original_key"]
                ),
                "account": self._normalized_type_account(),
            }
        }
        ...
        expected_record = {
            ...
            "streamalert_normalization": {
                "streamalert_record_id": MOCK_RECORD_ID,
                "normalized_key": [{"values": ["fizzbuzz"], "function": None}],
            },
        }
    ...
    def test_key_does_not_exist(self):
        ...
        expected_results = {
            "streamalert_record_id": MOCK_RECORD_ID,
            "account": [{"values": ["123456"], "function": None}],
            "region": [{"values": ["region_name"], "function": "AWS region"}],
        }
    ...
    def test_get_values_for_normalized_type(self):
        ...
        record = {
            "sourceIPAddress": "1.1.1.3",
            "streamalert_normalization": {
                "ip_v4": [{"values": expected_result, "function": None}],
            },
        }
        ...
        expected_config = {
            "cloudtrail": {
                "region": NormalizedType(
                    "cloudtrail", "region", ["path", "to", "awsRegion"]
                ),
        ...
        expected_config = {
            "cloudwatch:events": {
                ...
                "region": NormalizedType(
                    ...
                    "region",
                    [
                        {"path": ["region"], "function": "aws region information"},
                        {
                            "path": ["detail", "awsRegion"],
                            "function": "aws region information",
                        },
        ...
        config = {
            "logs": {
                "cloudwatch:events": {
                    ...
                    "parser": "json",
                    "configuration": {"normalization": {"foo": "bar"}},
                }
            }
        }
    ...
    def test_load_from_config_with_flag(self):
        ...
        record = {"source": "1.1.1.2", "destination": "2.2.2.2", "destport": "54321"}
        ...
        expect_result = {
            ...
            "streamalert_normalization": {
                "streamalert_record_id": MOCK_RECORD_ID,
                "ip_address": [
                    {"values": ["2.2.2.2"], "function": "Destination IP addresses"}
                ],
                "port": [
                    {
                        "values": ["54321"],
    ...
    def test_normalize_condition(self):
        ...
        expected_record = {
            ...
            "streamalert_normalization": {
                "streamalert_record_id": MOCK_RECORD_ID,
                "region": [{"values": ["region_name"], "function": "AWS region"}],
                "ipv4": [{"values": ["1.1.1.3"], "function": "source ip address"}],
            },
        }
        assert record == expected_record
