...
class TestAlertTable:
    ...
    def test_get_alert_records(self):
        ...
        result = list(
            self.alert_table.get_alert_records("odd", _ALERT_PROCESSOR_TIMEOUT_SEC)
        )
        assert 1 == len(result)
    ...
    def test_delete_alert(self):
        ...
        self.alert_table.delete_alerts(
            [(alert.rule_name, alert.alert_id) for alert in self.alerts]
        )
