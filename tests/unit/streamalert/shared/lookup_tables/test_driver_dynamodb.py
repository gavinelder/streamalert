...
class TestDynamoDBDriver:
    ...
    def test_initialize(self, mock_logger):
        ...
        mock_logger.assert_any_call(
            "LookupTable (%s): Running initialization routine", "dynamodb:table_name"
        )
    ...
    def test_botocore_read_timeout(self, mock_logger, boto_resource_fn_mock):
        ...
        mock_logger.assert_any_call(
            "LookupTable (%s): Reading from DynamoDB timed out", "dynamodb:table_name"
        )
            ...
            [
                {
                    ...
                    "DictField": {"message": {"depth": "Will this work?"}},
                }
            ],
        )
