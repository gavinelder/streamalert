...
class TestSlackOutput:
    ...
    def test_format_message_single(self):
        ...
        assert loaded_message['text'] == '*StreamAlert Rule Triggered: test_rule_single*'
    ...
    def test_max_attachments(self, log_mock):
        ...
        log_mock.assert_called_with('%s: %d-part message truncated to %d parts', alert_publication,
                                    21, 20)
